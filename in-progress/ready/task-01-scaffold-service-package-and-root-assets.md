...
next_prompt: |-
  You are implementing Task 1 from the FamilyOS Telegram MVP implementation plan.

  Start from this ticket:
  - Ticket: in-progress/ready/task-01-scaffold-service-package-and-root-assets.md
