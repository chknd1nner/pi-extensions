...
next_prompt: |-
  You are implementing Task 7 from the FamilyOS Telegram MVP implementation plan.

  Start from this ticket:
  - Ticket: in-progress/ready/task-07-session-list-and-ascii-tree-view-helpers.md
