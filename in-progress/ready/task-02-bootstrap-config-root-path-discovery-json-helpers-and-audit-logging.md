...
next_prompt: |-
  You are implementing Task 2 from the FamilyOS Telegram MVP implementation plan.

  Start from this ticket:
  - Ticket: in-progress/ready/task-02-bootstrap-config-root-path-discovery-json-helpers-and-audit-logging.md
